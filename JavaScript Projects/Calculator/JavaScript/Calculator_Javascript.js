...
const Calculator =
{
    ...
    First_Operand: null,
    //This checks whether the second operand has been entered by the user
    Wait_Second_Operand: false,
    //this will set the operator, we set it to null for now
    operator: null,
};
...
function Input_Digit(digit)
{
    ...
    //This checks if the Wait_Second_Operand is true and sets the Display_Value to the key that was clicked on
    if (Wait_Second_Operand === true)
    {
        ...
        //this operates Display_Value if the current value is 0, otherwise it adds onto it
...
function Input_Decimal(dot)
{
    ...
    {
        //we are saying that if the display value does not contain a dec point, we want to add to a decimal point
...
function Handle_Operator(Next_Operator)
{
    ...
    //when an operator key is pressed we convert the current number displayed on the screen to a number and then store the result in Calculator.First_Operand if it doesnt already exist 
